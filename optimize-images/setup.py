...
setup(name='optimize-images',
      ...
      author="Daniel Akinyoyenu",
      packages=find_packages(),
      include_package_data=False,
      long_description=read_readme('README.md'),  # for PyPI
      long_description_content_type="text/markdown",
      license='MIT',
      url='https://github.com/akdangtech/optimize-images',
      project_urls={
          'Documentation': 'https://github.com/akdangtech/optimize-images',
          'Source': 'https://github.com/akdangtech/optimize-images',
          'Bug Reports': 'https://github.com/akdangtech/optimize-images',
      },
      python_requires='>=3.7',
      classifiers=[
